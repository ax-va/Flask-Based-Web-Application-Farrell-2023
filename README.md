...
The first part, `xyz`, is the name of 'xyz.py'. Change `xyz` to a real script name: either `blog` or `app`. The second part, `:app`, refers to the Flask application instance `app` created in 'xyz.py':
```python
app: Flask = ...
```
